...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/10 06:06:59 by pdeshaye          #+#    #+#             */
/*   Updated: 2021/12/10 06:08:40 by pdeshaye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cond2(mlx_t *mlx_st, int x, int y)
{
	if (mlx_st->map_b[y][x] == 'N')
	{
		...
		refresh_map(mlx_st);
		put_image(mlx_st, mlx_st->map_sprite->tomb, mlx_st->player->pos_x * 64,
			mlx_st->player->pos_y * 64 + 64 + 18);
	}
