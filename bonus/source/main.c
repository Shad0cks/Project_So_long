...
void set_sprite(mlx_t *mlx_st)
{
	...
	mlx_st->map_sprite->wall = mlx_xpm_file_to_image(mlx_st->mlx, "bonus/sprite/wall.xpm", &width, &height);
	mlx_st->map_sprite->sand = mlx_xpm_file_to_image(mlx_st->mlx, "bonus/sprite/sand.xpm", &width, &height);
	mlx_st->map_sprite->item = mlx_xpm_file_to_image(mlx_st->mlx, "bonus/sprite/item.xpm", &width, &height);
	mlx_st->map_sprite->door = mlx_xpm_file_to_image(mlx_st->mlx, "bonus/sprite/door.xpm", &width, &height);
	mlx_st->map_sprite->tomb = mlx_xpm_file_to_image(mlx_st->mlx, "bonus/sprite/tomb.xpm", &width, &height);
}
